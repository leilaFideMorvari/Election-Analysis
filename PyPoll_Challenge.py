...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if county_name not in county_names:
            ...
            #use append to pass obj into the existing list.
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_names:
        ...
        county_results = f"{county}: {vote_percentage:.1f}% ({vote:,})\n"
        ...
        if (vote > largest_county_votes): 
            winning_county =  county_votes
            winning_country_turnout = county
